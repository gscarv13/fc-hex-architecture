...
import (
	...
	app "github.com/gscarv13/fc-hex-architecture/app"
)
...
func (m *MockProductServiceInterface) Create(name string, price float64) (app.ProductInterface, error) {
	m.ctrl.T.Helper()
...
func (m *MockProductServiceInterface) Disable(product app.ProductInterface) (app.ProductInterface, error) {
	m.ctrl.T.Helper()
...
func (m *MockProductServiceInterface) Enable(product app.ProductInterface) (app.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// Get mocks base method.
func (m *MockProductReader) Get(id string) (app.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(app.ProductInterface)
	ret1, _ := ret[1].(error)
...
func (m *MockProductWriter) Save(product app.ProductInterface) (app.ProductInterface, error) {
	m.ctrl.T.Helper()
